...
$$ \implies cf \cdot p - 1 = kq^2$$ 

for some integer $$k$$.  So multiplying by an additional factor of $$p$$ allows us to obtain 

$$ (cf \cdot p - 1)p = kpq^2 = kN$$.  This is just equivalent to saying that $$(cf \cdot p - 1)p \equiv 0 \pmod{N}$$.
